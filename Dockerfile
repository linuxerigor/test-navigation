...
#Running the image
#docker run -i --init --rm --cap-add=SYS_ADMIN --name puppeteer-chrome puppeteer-chrome-linux node -e "`cat index.js`"

docker run -i --init --rm --cap-add=SYS_ADMIN -v $(pwd)/tmp:/tmp --name puppeteer-chrome puppeteer-chrome-linux node -e "`cat index2.js`"
